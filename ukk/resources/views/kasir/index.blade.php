                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Belum Di Proses</h6>
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-bold-500">Hasyim Ashari</td>
                                                                <td>Ds. Jahulu, Kec. Bancar</td>
                                                                <td class="text-bold-500">0812345678</td>
                                                                <td>Laki-Laki</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-bold-500">Hasyim Ashari</td>
