                            ...
                            <section class="section">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Data Member</h3>
                                        <a href="{{ url('tambahmember') }}"><button type="button" class="btn btn-primary" >Tambah Member</button></a>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('editmember') }}"><button type="button" class="btn btn-success">Edit </button></a>
                                                    </td>
                                                </tr>
