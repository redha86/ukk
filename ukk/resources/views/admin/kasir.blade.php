                            ...
                            <section class="section">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Data Kasir</h3>
                                        <a href="{{ url('tambahpengguna') }}"><button type="button" class="btn btn-primary" >Tambah Kasir</button></a>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('kasiredit') }}"><button type="button" class="btn btn-success">Edit </button></a>
                                                    </td>
                                                </tr>
