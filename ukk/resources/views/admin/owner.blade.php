                            ...
                            <section class="section">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Data Owner</h3>
                                        <a href="{{ url('tambahpengguna') }}"><button type="button" class="btn btn-primary" >Tambah Owner</button></a>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('owneredit') }}"><button type="button" class="btn btn-success">Edit </button></a>
                                                    </td>
                                                </tr>
