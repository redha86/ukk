                                    ...
                                    <div class="col-md-6 col-12 col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title">Form Edit Paket Cucian</h4>
                                            </div>
                                                    ...
                                                    <form class="form form-vertical">
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="email-id-vertical">Jenis</label>
                                                                ...
                                                                <div class="col-12">
                                                                    <label for="first-name-vertical">Nomor Outlet</label>
