                                                ...
                                                <div class="card-body">
                                                    <form class="form form-vertical">
                                                        <div class="form-body">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <label for="first-name-vertical"> Id Outlet</label>
                                                                ...
                                                                <div class="col-12">
                                                                    <label for="first-name-vertical"> Id Member</label>
                                                                    <fieldset class="form-group">
                                                                        <select class="form-select" id="basicSelect">
                                                                            <option></option>
                                                                            <option>11111111</option>
                                                                ...
                                                                <div class="col-12">
                                                                    <label for="first-name-vertical"> Id Kasir</label>
                                                                    <fieldset class="form-group">
                                                                        <select class="form-select" id="basicSelect">
                                                                            <option></option>
                                                                            <option>11111111</option>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="first-name-vertical">Tanggal Pesanan</label>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="first-name-vertical">Batas Waktu</label>
                                                                        <input type="date" id="first-name-vertical"
                                                                            class="form-control" name="fname"
                                                                            placeholder="">
                                                                    </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="first-name-vertical">Tanggal Bayar</label>
                                                                        <input type="date" id="first-name-vertical"
                                                                            class="form-control" name="fname"
                                                                            placeholder="">
                                                                    </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="first-name-vertical">Diskon</label>
                                                                        <input type="text" id="first-name-vertical"
                                                                            class="form-control" name="fname"
                                                                            placeholder="Rp.">
                                                                    </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <label for="first-name-vertical"> Testimoni</label>
