                            ...
                            <section class="section">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Data Outlet</h3>
                                        <a href="{{ url('tambahoutlet') }}"><button type="button" class="btn btn-primary" >Tambah Outlet</button></a>
                                    </div>
                                        ...
                                        <table class="table table-striped text-center" id="table1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <a href="{{ url('hapusoutlet/'.$y->id) }}"> <button type="button" class="btn btn-danger">Hapus</button></a>
                                                        <a href="{{ url('editoutlet/'.$y->id) }}"><button type="button" class="btn btn-success">Edit </button></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
