                            ...
                            <section class="section">
                                <div class="card">
                                    <div class="card-header">
                                        <h3>Paket Cucian</h3>
                                        <a href="{{ url('tambahpaket') }}"><button type="button" class="btn btn-primary" >Tambah Paket</button></a>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-striped text-center" id="table1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Nomor Outlet</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Cuci Bersih</td>
                                                    <td>Baju dan celana</td>
                                                    <td>11111111</td>
                                                    <td>Rp. 30.000</td>
                                                    <td>
                                                        <button class="btn btn-danger">Hapus</button>
                                                        <a href="{{ url('editpaket') }}"><button class="btn btn-success">Edit</button></a>
                                                    </td>
                                                </tr>
